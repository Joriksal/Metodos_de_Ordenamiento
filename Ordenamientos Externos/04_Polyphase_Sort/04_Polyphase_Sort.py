...
def polyphase_merge_sort(runs_dir, output_file):
    """
    Realiza el Polyphase Merge Sort a partir de los runs ubicados en runs_dir
...
if __name__ == "__main__":
    ...
    input_file = "Ordenamientos Externos/04_Polyphase_Sort/unsorted_data.txt"
    # Ruta del archivo donde se guardará el resultado ordenado
    output_file = "Ordenamientos Externos/04_Polyphase_Sort/sorted_data.txt"
    # Carpeta donde se guardarán los runs
    runs_directory = "Ordenamientos Externos/04_Polyphase_Sort/runs"
    ...
    # Realizar la mezcla múltiple polifásica
    polyphase_merge_sort(runs_directory, output_file)
